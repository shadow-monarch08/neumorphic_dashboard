...
WATCH_CONFIG = [
    {
        ...
        "output": "./src/constants/icons.ts",
        "extensions": [".png", ".svg", ]
    },
    {
        "folder": "./src/assets/images",
        "output": "./src/constants/images.ts",
        "extensions": [".png", ".jpg", ".jpeg", ".svg"]
    },
    {
        "folder": "./src/assets/lottie",
        "output": "./src/constants/lottie.ts",
        "extensions": [".json"]
    },
    {
        "folder": "./src/assets/avatars",
        "output": "./src/constants/avatars.ts",
        "extensions": [".svg", ".png"]
    }
]
...
def generate_ts_file(folder, output_file, extensions):
    ...
    for file in files:
        ...
        # Relative path from the output TS file to the asset file
        rel_path = os.path.relpath(os.path.join(folder, file), os.path.dirname(output_file)).replace("\\", "/")
